...
# Motor Calibration command bytes (written to MOTOR_CALIBRATION_UUID)
CALIBRATION_VENETIAN_ON = bytes([0xA8])
CALIBRATION_VENETIAN_OFF = bytes([0xA9])
...
TILT_UP = "up"
TILT_DOWN = "down"
TILT_DIRECTION_OPTIONS = [TILT_UP, TILT_DOWN]

# Venetian mode options
VENETIAN_ON = "on"
VENETIAN_OFF = "off"
VENETIAN_MODE_OPTIONS = [VENETIAN_ON, VENETIAN_OFF]
